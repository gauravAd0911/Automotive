...
<?php echo "Welcome: ". $_SESSION['id']; ?>
      <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <table>
            ...
            ?>
            <tr><td>Area: &nbsp;</td><td><select name="area" onchange="javascript: search(this.value)" class="form-control" id="area" style="width: 200px">
            ...
            <?php
                ...
                if(isset($_GET['area'])){           
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<br/><input type='submit' value='{$row1['name']} - {$row['addr']}' onclick='javascript: park(this.value)' style='width: 500px;' class='btn btn-primary'/><br/>";
                    }
                }
                ...
                if(isset ($_GET['type'])){  
                    ...
                    $t=$name[1];
                    $i=1;
                    $query="select s.id,s.username,s.area,s.address,s.type,s.slots,u.location,u.username,u.name from tblslots as s,tbluser as u where s.address='$t' and s.area='{$_SESSION['area']}' and u.username=s.username";
